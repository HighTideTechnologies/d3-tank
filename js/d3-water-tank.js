(function ($) {
  ...
  class AnalogTank {
    ...
    textFormatter(val) {
      if (this.fillUnit) {
        return `${parseFloat(val).toFixed(this.decimal)} ${this.fillUnit}`;
      }
    ...
    lookupTextFormatter(val) {
      if (this.lookupTableValueUnit) {
        return `${parseFloat(val).toFixed(this.lookupTableValueDecimal)} ${this.lookupTableValueUnit}`;
      }
      return `${parseFloat(val).toFixed(this.lookupTableValueDecimal)}`;
    }

    changeRateValueTextFormatter(val) {
      if (this.changeRateValueUnit) {
        return `${parseFloat(val).toFixed(this.lookupTableValueDecimal)} ${this.changeRateValueUnit}`;
      }
      return `${parseFloat(val).toFixed(this.lookupTableValueDecimal)}`;
    }
    ...
    calculateArrowPosition () {
      ...
      if (this.changeRateValueArrowEnabled && this.changeRateValueEnabled) {
        ...
        yOffset = this.overlayText.node().getBBox().height + this.arrowYOffset + this.changeRateValueArrowYOffset;

        if (this.lookupTableValueEnabled) {
          yOffset += this.lookupTableValueOverlayText.node().getBBox().height;
        }
      } else {
